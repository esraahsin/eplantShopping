...
function ProductList() {
    ...
    const cartQuantity = useSelector(state => state.cart.totalQuantity); // Get totalQuantity from Redux store
   ...
   const handleCartClick = (e) => {
    ...
    setShowPlants(false); // Hide the plants
};
    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                ...
                {cartQuantity > 0 && <span className="cart_quantity_count">{cartQuantity}</span>} {/* Display totalQuantity */}
                </h1></a></div>
            </div>
        </div>
        {!showCart? (
